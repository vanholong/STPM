...
from BaseLine.Model import Utils
import argparse
import os
...
config = BaseLineConf(name, maxper, minSR, minPS, dataset, max_pattern_size, epsilon, minoverlap, mindist, maxdist, output, save_patterns, in_details)
